...
export const folders = pgTable(
  "folders",
  {
    ...
    permanentlyDeletedBy: uuid("permanently_deleted_by").references(() => users.id),
...
export const media = pgTable(
  ...
  (table) => [
    index("media_space_folder_taken_idx").on(table.spaceId, table.folderId, table.takenAt),
    index("media_space_deleted_idx").on(table.spaceId, table.deletedAt),
    index("media_space_permanent_idx").on(table.spaceId, table.permanentlyDeletedAt),
