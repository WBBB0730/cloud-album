...
function LoginContent() {
  ...
  const [initialValues, setInitialValues] = useState({ phone: "", password: "" })
    ...
    <MobileFrame variant="auth">
      ...
      >
        ...
        <label className="ca-field">
          <span>手机号</span>
          <Input name="phone" inputMode="tel" autoComplete="tel" className="ca-input" defaultValue={initialValues.phone} />
        </label>
        <label className="ca-field">
          <span>密码</span>
          <Input name="password" type="password" autoComplete="current-password" className="ca-input" defaultValue={initialValues.password} />
        </label>
